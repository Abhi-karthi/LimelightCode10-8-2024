...
@TeleOp(name = "Color Detect and Align with Limelight")
class Limelight extends OpMode {
    ...
    public void init() {
        ...
        limelight.pipelineSwitch(activePipeline); // Default to pipeline 0 (yellow)
    ...
    public void loop() {
        ...
        // Calculate distance to the target (assuming targetArea correlates with distance)
